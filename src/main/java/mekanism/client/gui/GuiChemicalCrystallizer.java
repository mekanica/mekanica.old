...
public class GuiChemicalCrystallizer extends GuiMekanism<TileEntityChemicalCrystallizer> {
    ...
    public GuiChemicalCrystallizer(InventoryPlayer inventory, TileEntityChemicalCrystallizer tile) {
        ...
        guiElements.add(new GuiPowerBar(this, tileEntity, resource, 160, 23));
        ...
        guiElements.add(new GuiGasGauge(() -> tileEntity.inputTank, GuiGauge.Type.STANDARD, this, resource, 5, 4));
        guiElements.add(new GuiSlot(SlotType.EXTRA, this, resource, 5, 64).with(SlotOverlay.PLUS));
        guiElements.add(new GuiSlot(SlotType.POWER, this, resource, 154, 4).with(SlotOverlay.POWER));
        guiElements.add(new GuiSlot(SlotType.OUTPUT, this, resource, 130, 56));
