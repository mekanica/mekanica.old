...
public class GuiChemicalWasher extends GuiMekanism<TileEntityChemicalWasher> {
    ...
    public GuiChemicalWasher(InventoryPlayer inventory, TileEntityChemicalWasher tile) {
        ...
        guiElements.add(new GuiBucketIO(this, resource));
        ...
        guiElements.add(new GuiFluidGauge(() -> tileEntity.fluidTank, Type.STANDARD, this, resource, 5, 4));
        guiElements.add(new GuiGasGauge(() -> tileEntity.inputTank, GuiGauge.Type.STANDARD, this, resource, 26, 13));
        guiElements.add(new GuiGasGauge(() -> tileEntity.outputTank, GuiGauge.Type.STANDARD, this, resource, 133, 13));
